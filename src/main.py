...
syn_img = rec()
F_final, S_final = reconstruction.rec(syn_img.data, blend_name)
torch.save(F_final, './results/' + blend_name + '/F_final.pth')
torch.save(S_final, './results/' + blend_name + '/S_final.pth')

F_final = torch.load('./results/' + blend_name + '/F_final.pth')
S_final = torch.load('./results/' + blend_name + '/S_final.pth')

rec.blend_final(F_final, S_final)
print('ok')
