...
from utils.c_utils import save_img
sys.path.append('./')
import torch
import os
...
import sys
sys.path.append('./')
from models.mask import deeplab_xception_transfer
from models.mask.graphonomy_inference import get_mask
...
def gen_fullhair(image_hair, mask_hair):
    ...
    with torch.no_grad():
        mask_hair = erosion(mask_hair, iteration=5)
