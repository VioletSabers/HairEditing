...
class ProgressiveBackboneEncoder(Module):
    ...
    def __init__(self, num_layers, mode='ir', n_styles=18, opts=None):
        ...
        self.input_layer = Sequential(Conv2d(cfg.restyle_e4e.input_nc, 64, (3, 3), 1, 1, bias=False),
                                      BatchNorm2d(64),
                                      PReLU(64))
        modules = []
        for block in blocks:
...
class ResNetProgressiveBackboneEncoder(Module):
    ...
    def __init__(self, n_styles=18, opts=None):
        ...
        self.conv1 = nn.Conv2d(cfg.restyle_e4e.input_nc, 64, kernel_size=7, stride=2, padding=3, bias=False)
