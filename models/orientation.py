...
class orient(nn.Module):
    def __init__(self, channel_in=1, channel_out=1, stride=1, padding=8):
        ...
        self.filterKernel = torch.cat(self.filterKernel, dim=0).unsqueeze(1)
...
if __name__ == '__main__':
    class args:
        ...
        image_path = '../data/images/67172.jpg'
        hairmask_path = '../data/masks/67172.png'
    ...
    # select = (orient_numpy > 100) & (orient_numpy < 200)
    orient_np = orient_numpy
